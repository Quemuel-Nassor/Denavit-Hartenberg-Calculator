    ...
    public class CalculatorManager : ICalculatorManager
    {
        ...
        public double[,] GenerateMatrixAn(Joint input)
        {
            try
            {
                ...
                // row 0
                MatrixAi.SetValue(Math.Cos(input.ThetaRadians), 0, 0);
                MatrixAi.SetValue((-Math.Cos(input.AlphaRadians) * Math.Sin(input.ThetaRadians)), 0, 1);
                MatrixAi.SetValue(Math.Sin(input.AlphaRadians) * Math.Sin(input.ThetaRadians), 0, 2);
                MatrixAi.SetValue(input.DistanceA * Math.Cos(input.ThetaRadians), 0, 3);

                // row 1
                MatrixAi.SetValue(Math.Sin(input.ThetaRadians), 1, 0);
                MatrixAi.SetValue(Math.Cos(input.AlphaRadians) * Math.Cos(input.ThetaRadians), 1, 1);
                MatrixAi.SetValue((-Math.Sin(input.AlphaRadians) * Math.Cos(input.ThetaRadians)), 1, 2);
                MatrixAi.SetValue(input.DistanceA * Math.Sin(input.ThetaRadians), 1, 3);

                // row 2
                MatrixAi.SetValue(0, 2, 0);
                MatrixAi.SetValue(Math.Sin(input.AlphaRadians), 2, 1);
                MatrixAi.SetValue(Math.Cos(input.AlphaRadians), 2, 2);
